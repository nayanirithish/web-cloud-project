...
"SELECT fname, throughput FROM performance ORDER BY throughput DESC");
...
while(rs.next()){
    ...
    values.append(rs.getDouble("throughput")).append(",");
}
...
<span class="navbar-brand">System Throughput Analysis</span>
...
<h4 class="mb-3">File Throughput Performance</h4>
